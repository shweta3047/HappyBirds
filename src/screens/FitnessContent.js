...
const FitnessContent = ({route}) => {
    ...
    const [url, setUrl] = useState(
      'https://us-central1-mental-health-app-6edbd.cloudfunctions.net/app/api/fitness/'+route.params.category+"/"+route.params.subcategory+"/getContent",
    );
      ...
      <View style={styles.container}>
        ...
        <Grid
          ...
          columnWrapperStyle={{justifyContent: 'space-between'}}>
           ...
           <Image source={require('../assets/no-data.jpg')} style={{width: 200, height: 200}}></Image>
           <Text style={{paddingHorizontal:5}}>Uh ohh! We are hard at curating the most useful data for you. </Text>
           </View>
