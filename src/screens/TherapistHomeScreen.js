...
import psychatrist from '../assets/pshyc.png'
import counsellor from '../assets/counsellor.png'
import socialWorker from '../assets/social-worker.png'
// import data from '../constants/doctors'
...
const TherapistScreen = (props) => {
    const categories=[
        ...
        },
        {
            id:'2',
            name:"Psychiatrist",
            img: "https://icon-library.com/images/psychiatrist-icon/psychiatrist-icon-23.jpg"
        },
        {
            id:'3',
            name:"Counsellor",
  ...
  const renderItem=({item})=>{
    return (
        <TouchableOpacity 
        onPress={()=>props.navigation.navigate('Therapist',
  ...
  return (
    ...
    <ScrollView>
        ...
        <View>
                <Text style={{paddingHorizontal:20,fontSize:fonts.h3.fontSize}}>Top Therapists</Text>
