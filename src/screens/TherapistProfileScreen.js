           ...
           <AntDesign name="arrowleft" size={32} color="white" style={{position:"absolute",top:25,left:20}} 
            ...
            <Text style={styles.profileText}>Therapist Profile</Text>
                <View style={styles.dpCover} >
                    <Image style={{width:100,height:100,borderRadius:62}} source={{uri: therapist.img}} />
                </View>
            </View>
            ...
            <View style={{display:'flex',flexDirection:'row',justifyContent:'center'}}>
                    <Button mode="contained" color='#face4b' style={{width:'90%',borderRadius:10,marginTop:20}} 
